...
import {
  ...
  specialties,
  finmaStatuses,
} from "../../views/MemberForm/selectData";
...
const UpdateMemberForm = () => {
  ...
  const { data: responseData, refetch } = useGetMemberById(id);
  ...
  const {
    ...
    () => {
      ...
      navigate("/dashboard/reports/members");
    },
    (error) => {
            ...
            <Stack direction={{ xs: "column", md: "row" }} spacing={3}>
              ...
              <FormControl fullWidth>
                ...
                <Autocomplete
                  ...
                  options={specialties.map((option) => option.value)}
